...
public class MainActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (date.isEmpty() || weightStr.isEmpty()) {
                    Toast.makeText(MainActivity.this,
                            "Please enter both date and weight", Toast.LENGTH_SHORT).show();
                    return;
                }

                // Parse the weight value from the input string
                double weight;
                try {
    ...
    private void showGoalWeightDialog() {
        ...
        // Save button updates the goal weight in the database
        builder.setPositiveButton("Save", (dialog, which) -> {
    ...
    private void sendGoalReachedSms(double currentWeight, double goalWeight) {
        ...
        Cursor settingsCursor = databaseHelper.getNotificationSettings(currentUserId);
